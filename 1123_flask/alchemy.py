...
def UpdateAccount(id,user_name,password,title,salary): #更新
    with session_scope() as session:
        ...
        account.title = title
InsertAccount("David Li" , "123" , "System Manger" , 3000)
...
InsertAccount("Van Berg" , "123" , "General Manger" , None)
InsertAccount("Howard" , "123" , "General Manger" , 3000)
